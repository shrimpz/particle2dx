...
function dumpToInputTag(p_slot){
		...
		$('#start_a_var_text').val(start_col_var.a);
		$('#start_r_var').val(start_col_var.r);		
		$('#start_r_var_text').val(start_col_var.r);		
		$('#start_g_var').val(start_col_var.g);
		$('#start_g_var_text').val(start_col_var.g);
		$('#start_b_var').val(start_col_var.b);
		$('#start_b_var_text').val(start_col_var.b);
		...
		$('#startSpin_var').val(emitter[p_slot].getStartSpinVar());
		$('#startSpin_var_text').val(emitter[p_slot].getStartSpinVar());
		$('#start_spin_disp').html(emitter[p_slot].getStartSpin()+"±"+emitter[p_slot].getStartSpinVar());	
		
		end_col=emitter[p_slot].getEndColor();
		$('#end_a').val(end_col.a);
		$('#end_a_text').val(end_col.a);
		$('#end_r').val(end_col.r);		
		$('#end_r_text').val(end_col.r);		
		$('#end_g').val(end_col.g);
		$('#end_g_text').val(end_col.g);
		$('#end_b').val(end_col.b);
		$('#end_b_text').val(end_col.b);
		...
		$('#end_a_var_text').val(end_col_var.a);
		$('#end_r_var').val(end_col_var.r);		
		$('#end_r_var_text').val(end_col_var.r);		
		$('#end_g_var').val(end_col_var.g);
		$('#end_g_var_text').val(end_col_var.g);
		$('#end_b_var').val(end_col_var.b);
		$('#end_b_var_text').val(end_col_var.b);
		...
		$('#endSpin_var_text').val(emitter[p_slot].getEndSpinVar());
